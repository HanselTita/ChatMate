    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SendVerificationCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    ...
                    LoadingBar. setMessage("Authenticating your Phone.Please wait...");
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(PhoneLoginActivity.this, "Please Type in verification code.", Toast.LENGTH_SHORT).show();
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e)
            {
                ...
                Toast.makeText(PhoneLoginActivity.this,
                        "Invalid Number, please enter the correct phone number with your country code.", Toast.LENGTH_SHORT).show();
